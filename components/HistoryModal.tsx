...
const HistoryModal: React.FC<HistoryModalProps> = ({ history, onClose, onSelect, onRemove, onClearAll, initialFilter = 'all' }) => {
  ...
  return (
    <motion.div 
      ...
      className="fixed inset-0 z-[1100] flex items-center justify-center p-3 bg-black/80 backdrop-blur-xl"
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar bg-base-200/20">
                  ...
                  >
                    <div className="aspect-video relative overflow-hidden bg-base-300">
                      ...
                      <div className="absolute top-2 left-2">
                        <span className={`px-2 py-1 rounded text-[7px] font-black uppercase tracking-widest ${item.type === 'anime' ? 'bg-purple-500/20 text-purple-500' : 'bg-blue-500/20 text-blue-500'}`}>
                          {item.type}
                        </span>
                      </div>
