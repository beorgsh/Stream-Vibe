    ...
    <div className="flex flex-col items-center justify-center space-y-20 py-12 px-4 text-base-content">
      ...
      <section className="text-center space-y-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-sm md:text-lg text-base-content/60 font-medium max-w-2xl mx-auto leading-relaxed">
        ...
        >
          ...
          <button 
            ...
            className="btn btn-outline border-base-content/20 text-base-content rounded-full px-8 h-12 text-xs font-black uppercase tracking-widest hover:bg-base-content hover:text-base-100 hover:border-base-content transition-all"
          >
      ...
      <section className="w-full max-w-5xl space-y-8">
        <div className="text-center space-y-2">
            ...
            <p className="text-xs text-base-content/40 font-bold uppercase tracking-widest">Simple. Fast. Efficient.</p>
        </div>
      ...
      <section className="w-full max-w-3xl space-y-6">
        <div className="flex items-center gap-2 border-b border-base-content/10 pb-4 mb-6">
                        ...
                        {openFaqIndices.includes(i) && (
                            ...
                            >
                                <div className="px-4 pb-4">
                                    <p className="text-xs text-base-content/60 leading-relaxed border-t border-base-content/5 pt-3">{faq.a}</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
      ...
      {/* Tech Stack Marquee */}
      <div className="w-full max-w-4xl py-12 border-y border-base-content/5 overflow-hidden relative">
