  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="bg-base-100 border border-red-500/20 w-full max-w-md rounded-2xl p-6 shadow-[0_0_50px_rgba(239,68,68,0.1)] relative"
      >
        <button onClick={onClose} className="absolute top-4 right-4 text-base-content/20 hover:text-base-content transition-colors">
          <X size={20} />
        </button>
        ...
        <div className="flex flex-col items-center text-center space-y-5">
          ...
          <div className="space-y-1">
            <h2 className="text-xl font-black text-base-content uppercase tracking-tight">Stream Experience</h2>
            <p className="text-[10px] font-bold text-red-400/80 uppercase tracking-widest">Important Recommendation</p>
          </div>
          
          <div className="space-y-4 text-sm text-base-content/60 leading-relaxed font-medium">
            <p>
              To ensure the best streaming experience on <span className="text-base-content font-bold">StreamVibe</span>, we strongly recommend using <span className="text-primary font-bold">Brave Browser</span> or installing an <span className="text-primary font-bold">AdBlock</span> extension.
            </p>
            <div className="bg-base-content/5 p-4 rounded-xl border border-base-content/5 text-left flex gap-3">
